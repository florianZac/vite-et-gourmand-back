...
-- Noël (plats 1-24)
(1, 'Velouté de châtaigne et foie gras poêlé', 'https://images.unsplash.com/photo-1547592166-23ac45744acd?w=800', 'Entrée'),
(2, 'Magret de canard aux cèpes', 'https://images.unsplash.com/photo-1576402187878-974f70c890a5?w=800', 'Plat'),
(3, 'Bûche à l''Armagnac et marrons glacés', 'https://images.unsplash.com/photo-1608039829572-78524f79c4c7?w=800', 'Dessert'),
(4, 'Saumon fumé maison, blinis et crème citronnée', 'https://images.unsplash.com/photo-1482275548304-a58859dc31b7?w=800', 'Entrée'),
(5, 'Dinde de Noël farcie aux marrons et foie gras', 'https://images.unsplash.com/photo-1606787366850-de6330128bfc?w=800', 'Plat'),
(6, 'Bûche Montblanc revisitée', 'https://images.unsplash.com/photo-1563245372-f21724e3856d?w=800', 'Dessert'),
(7, 'Verrines de crevettes et avocat', 'https://images.unsplash.com/photo-1467003909585-2f8a72700288?w=800', 'Entrée'),
(8, 'Chapon rôti aux légumes d''hiver', 'https://images.unsplash.com/photo-1543362906-acfc16c67564?w=800', 'Plat'),
(9, 'Charlotte aux fraises des bois', 'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=800', 'Dessert'),
(10, 'Soupe de courge butternut épicée', 'https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=800', 'Entrée'),
(11, 'Wellington de légumes d''hiver', 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=800', 'Plat'),
(12, 'Mousse au chocolat noir et orange confite', 'https://images.unsplash.com/photo-1540914124281-342587941389?w=800', 'Dessert'),
(13, 'Foie gras d''Alsace au Gewurztraminer', 'https://images.unsplash.com/photo-1559339352-11d035aa65de?w=800', 'Entrée'),
(14, 'Choucroute festive aux trois viandes', 'https://images.unsplash.com/photo-1600891964092-4316c288032e?w=800', 'Plat'),
(15, 'Bredele et strudel aux pommes', 'https://images.unsplash.com/photo-1482275548304-a58859dc31b7?w=800', 'Dessert'),
(16, 'Œuf en cocotte aux truffes noires', 'https://images.unsplash.com/photo-1547592166-23ac45744acd?w=800', 'Entrée'),
(17, 'Confit de canard maison, sarladaise', 'https://images.unsplash.com/photo-1576402187878-974f70c890a5?w=800', 'Plat'),
(18, 'Fondant au chocolat et glace truffe', 'https://images.unsplash.com/photo-1608039829572-78524f79c4c7?w=800', 'Dessert'),
(19, 'Velouté de panais aux épices de Noël', 'https://images.unsplash.com/photo-1467003909585-2f8a72700288?w=800', 'Entrée'),
(20, 'Rôti de seitan aux herbes et légumes confits', 'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=800', 'Plat'),
(21, 'Bûche vegan chocolat-noisette', 'https://images.unsplash.com/photo-1563245372-f21724e3856d?w=800', 'Dessert'),
(22, 'Royale de caviar et homard en gelée', 'https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=800', 'Entrée'),
(23, 'Filet de bœuf Rossini, sauce Périgueux', 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=800', 'Plat'),
(24, 'Bûche Ispahan framboise rose litchi', 'https://images.unsplash.com/photo-1540914124281-342587941389?w=800', 'Dessert'),
-- Pâques (plats 25-45)
(25, 'Asperges blanches sauce mousseline', 'https://images.unsplash.com/photo-1555939594-58d7cb561ad1?w=800', 'Entrée'),
(26, 'Gigot d''agneau de lait rôti aux herbes', 'https://images.unsplash.com/photo-1498837167922-ddd27525d352?w=800', 'Plat'),
(27, 'Tarte citron meringuée', 'https://images.unsplash.com/photo-1490818387583-1baba5e638af?w=800', 'Dessert'),
(28, 'Tartare de saumon citron-aneth', 'https://images.unsplash.com/photo-1466637574441-749b8f19452f?w=800', 'Entrée'),
(29, 'Carré d''agneau en croûte de pistaches', 'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=800', 'Plat'),
(30, 'Œufs en chocolat surprise', 'https://images.unsplash.com/photo-1490818387583-1baba5e638af?w=800', 'Dessert'),
(31, 'Salade d''asperges et chèvre frais', 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=800', 'Entrée'),
(32, 'Tarte tatin aux légumes printaniers', 'https://images.unsplash.com/photo-1498837167922-ddd27525d352?w=800', 'Plat'),
(33, 'Nid de Pâques en meringue', 'https://images.unsplash.com/photo-1540914124281-342587941389?w=800', 'Dessert'),
(34, 'Anchoïade et légumes crus', 'https://images.unsplash.com/photo-1543362906-acfc16c67564?w=800', 'Entrée'),
(35, 'Épaule d''agneau confite 7 heures', 'https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=800', 'Plat'),
(36, 'Calisson glacé au miel de lavande', 'https://images.unsplash.com/photo-1555939594-58d7cb561ad1?w=800', 'Dessert'),
(37, 'Gaspacho vert aux herbes fraîches', 'https://images.unsplash.com/photo-1467003909585-2f8a72700288?w=800', 'Entrée'),
(38, 'Lentilles du Puy aux légumes racines', 'https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=800', 'Plat'),
(39, 'Fondant au chocolat noir vegan', 'https://images.unsplash.com/photo-1606787366850-de6330128bfc?w=800', 'Dessert'),
(40, 'Terrine de campagne printanière', 'https://images.unsplash.com/photo-1490818387583-1baba5e638af?w=800', 'Entrée'),
(41, 'Blanquette de veau à l''ancienne', 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=800', 'Plat'),
(42, 'Fraisier classique', 'https://images.unsplash.com/photo-1498837167922-ddd27525d352?w=800', 'Dessert'),
(43, 'Piperade basque et jambon de Bayonne', 'https://images.unsplash.com/photo-1540914124281-342587941389?w=800', 'Entrée'),
(44, 'Agneau du Pays Basque rôti', 'https://images.unsplash.com/photo-1543362906-acfc16c67564?w=800', 'Plat'),
(45, 'Gâteau basque à la cerise noire', 'https://images.unsplash.com/photo-1555939594-58d7cb561ad1?w=800', 'Dessert'),
-- Mexicain (plats 46-48)
(46, 'Nachos au fromage et guacamole', 'https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=800', 'Entrée'),
(47, 'Tacos de poulet épicé', 'https://images.unsplash.com/photo-1551504734-5ee1c4a1479b?w=800', 'Plat'),
(48, 'Churros au chocolat', 'https://images.unsplash.com/photo-1559339352-11d035aa65de?w=800', 'Dessert'),
-- Asiatique (plats 49-51)
(49, 'Rouleaux de printemps aux crevettes', 'https://images.unsplash.com/photo-1563245372-f21724e3856d?w=800', 'Entrée'),
(50, 'Poulet au curry thaï et riz parfumé', 'https://images.unsplash.com/photo-1455619452474-d2be8b1e70cd?w=800', 'Plat'),
(51, 'Perles de coco', 'https://images.unsplash.com/photo-1482275548304-a58859dc31b7?w=800', 'Dessert'),
-- Jour de l''An (plats 52-54)
(52, 'Velouté de potiron et paprika', 'https://images.unsplash.com/photo-1547592166-23ac45744acd?w=800', 'Entrée'),
(53, 'Filet mignon sauce truffe', 'https://images.unsplash.com/photo-1600891964092-4316c288032e?w=800', 'Plat'),
(54, 'Tartelette au chocolat et éclats de caramel', 'https://images.unsplash.com/photo-1608039829572-78524f79c4c7?w=800', 'Dessert'),
-- Italien (plats 55-57)
(55, 'Antipasti variés', 'https://images.unsplash.com/photo-1498837167922-ddd27525d352?w=800', 'Entrée'),
(56, 'Risotto aux champignons sauvages', 'https://images.unsplash.com/photo-1476124369491-e7addf5db371?w=800', 'Plat'),
(57, 'Tiramisu classique', 'https://images.unsplash.com/photo-1571877227200-a0d98ea607e9?w=800', 'Dessert'),
-- Français (plats 58-60)
(58, 'Soupe à l''oignon gratinée', 'https://images.unsplash.com/photo-1547592166-23ac45744acd?w=800', 'Entrée'),
(59, 'Boeuf Bourguignon', 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=800', 'Plat'),
(60, 'Crème brûlée', 'https://images.unsplash.com/photo-1470124182917-cc6e71b22ecc?w=800', 'Dessert'),
-- Classique (plats 61-66)
(61, 'Saumon mariné à l''aneth', 'https://images.unsplash.com/photo-1467003909585-2f8a72700288?w=800', 'Entrée'),
(62, 'Poulet rôti à la provençale', 'https://images.unsplash.com/photo-1598103442097-8b74f568ef73?w=800', 'Plat'),
(63, 'Clafoutis aux cerises', 'https://images.unsplash.com/photo-1490818387583-1baba5e638af?w=800', 'Dessert'),
(64, 'Soupe de légumes de saison', 'https://images.unsplash.com/photo-1547592166-23ac45744acd?w=800', 'Entrée'),
(65, 'Gratin dauphinois et rôti de veau', 'https://images.unsplash.com/photo-1600891964092-4316c288032e?w=800', 'Plat'),
(66, 'Tarte aux pommes classique', 'https://images.unsplash.com/photo-1568571780765-9276ac8b75a2?w=800', 'Dessert');
